...
class DnCNN(nn.Module):
    def __init__(self, in_nc=1, out_nc=1, nc=64, nb=17, act_mode='BR'):
        ...
        m_head = B.conv_layers(in_nc, nc, mode='C' + act_mode[-1], bias=bias)
        m_body = [B.conv_layers(nc, nc, mode='C' + act_mode, bias=bias) for _ in range(nb - 2)]
        m_tail = B.conv_layers(nc, out_nc, mode='C', bias=bias)
