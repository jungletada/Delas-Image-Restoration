...
# convert uint (H x W x n_channels) to 4-dimensional torch tensor
...
# (1) augmet_img: numpy image of w x h x c or w x h
# (2) augment_img_tensor4: tensor image 1 x c x w x h
# =======================================
'''
...
def augment_img(img, mode=0):
    if mode == 0:
        return img
    elif mode == 1: # np.flipud(): flip the matrix
...
def augment_img_tensor4(img, mode=0):
    ...
    if mode == 0:
        ...
        return img.rot90(1, [2, 3]).flip([flip_dim])
    elif mode == 2:
        return img.flip([flip_dim])
    elif mode == 3:
        return img.rot90(3, [2, 3])
    elif mode == 4:
        return img.rot90(2, [2, 3]).flip([flip_dim])
    elif mode == 5:
        return img.rot90(1, [2, 3])
    elif mode == 6:
        return img.rot90(2, [2, 3])
    elif mode == 7:
        return img.rot90(3, [2, 3]).flip([flip_dim])
